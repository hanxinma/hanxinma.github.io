...
const root_char =['gè', 'gǎn', 'qiáng', 'shàng', 'qiè', 'shēng', 'gāo', 'hé', 'tóu', 'ér', 'xiàng', 'yǐ', 'ān', 'jǐn', 'jiù', 'zhǎng', 'kàn', 'kuǎ', 'jiā', 'yún', 'shì', 'mó', 'xià', 'jiǎ', 'duì', 'sān', 'tiáo', 'shuāi', 'tā', 'cháo', 'huái', 'lǜ', 'zài', 'běn', 'miàn', 'bō', 'yú', 'méi', 'rán', 'xiē', 'jiǔ', 'lüè', 'kuàng', 'fǎ', 'jiū']
const root_code = ['is', 'iq', 'lt', 'jg', 'lq', 'jk', 'iw', 'ck', 'tx', 'br', 'ng', 'uy', 'mr', 'os', 'ob', 'kc', 'pp', 'pu', 'oh', 'uh', 'ja', 'vs', 'nv', 'op', 'hl', 'yv', 'tp', 'jf', 'tq', 'wo', 'ce', 'gi', 'em', 'dn', 'vx', 'db', 'uw', 'vy', 'rj', 'nn', 'ok', 'gf', 'pm', 'ff', 'oc']
