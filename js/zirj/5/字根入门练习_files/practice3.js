...
const root_char =['guǎn', 'yī', 'huā', 'chē', 'dōu', 'xīn', 'liǎng', 'ma', 'diǎn', 'guó', 'dá', 'yǔ', 'suī', 'néng', 'jiǒng', 'fēi', 'xiá', 'wǒ', 'hǎo', 'xiōng', 'huí', 'dà', 'huáng', 'yuē', 'wèn', 'zhèng', 'ér', 'ào', 'xuě', 'quán', 'cháng', 'nǚ', 'chū', 'huà', 'hǎi', 'fāng', 'shí', 'áng', 'xióng', 'jiě', 'qǐng', 'xué', 'kāi', 'guǎi', 'guǎng']
const root_code = ['ip', 'ue', 'cb', 'ww', 'hq', 'nf', 'gs', 'vm', 'hz', 'ib', 'ht', 'ud', 'ya', 'ru', 'om', 'fy', 'nz', 'su', 'cz', 'nc', 'cf', 'hs', 'cm', 'uc', 'sm', 'kx', 'bm', 'ma', 'no', 'lv', 'wp', 'rp', 'wr', 'ca', 'cg', 'fu', 'ji', 'mv', 'nl', 'ou', 'lc', 'nr', 'pg', 'in', 'iv']
