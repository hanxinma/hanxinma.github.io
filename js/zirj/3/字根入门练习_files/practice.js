...
const root_char = ['r', 'uán', 'ǎng', 'á', 'sh', 'éi', 'j', 'p', 'r4', 'āo', 'uàng', 'ī', 'uái', 'én', 'án', 's', 'ǔn', 'iáo', 'uài', 'n3', 'x', 'ín', 'uò', 'ān', 'uē', 'ǐng', 'iāo', 'e', 'z', 'iǎng', 'iā', 'óu', 'ēng', 'īng', 'èng', 'iě', 'uáng', 'm', 'g', 'ú', 'iǎn', 'iè', 'a', 'uí', 'áng', 'uó', 'ié', 'c', 'uī', 'n', 'iū', 'ā', 'ng4', 'ǘ']
const root_code = ['r', 'v', 'c', 't', 'j', 'y', 'o', 'q', 'i', 'w', 'm', 'e', 'e', 'i', 'j', 'y', 'g', 'p', 'x', 'h', 'n', 'm', 'j', 'v', 'c', 'c', 'b', 'b', 'e', 's', 'h', 'x', 'k', 'g', 'x', 'u', 'm', 'v', 'i', 'w', 'z', 'q', 'm', 'f', 'p', 'b', 'p', 'z', 'a', 'r', 'c', 'q', 'q', 'f']
