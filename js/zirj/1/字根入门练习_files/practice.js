...
const root_char = ['uà', 'b', 'uǒ', 'l', 'ò', 'ái', 'òng', 'ìng', 'iú', 'en', 'iù', 'ch', 'iē', 'ěng', 'áo', 'o', 'uān', 'è', 'ǒ', 'iàng', 'ǎo', 'ián', 'iāng', 'ài', 'uō', 'ǎn', 'uǐ', 'ià', 'uǎ', 'f', 'èi', 'ǒu', 'k', 'iàn', 'uǎn', 'uá', 'é', 'uè', 'zh', 'uǎi', 'ng', 'r', 'ǜ', 'ǎ', 'uàn', 'à', 'āng', 'ōu', 'ióng', 'w', 'uì', 'ūn', 'ùn', 'ēi', 'y']
const root_code =  ['a', 'd', 'd', 'g', 'n', 'h', 'r', 'd', 'u', 'z', 'b', 'w', 'n', 'b', 'o', 'a', 'g', 's', 'u', 'g', 'z', 'n', 'w', 'm', 't', 'q', 'n', 'v', 'u', 'f', 'h', 'b', 'p', 'x', 'p', 'q', 'k', 'z', 'k', 'n', 'v', 'm', 'i', 'f', 't', 's', 'u', 'q', 'l', 's', 'l', 'y', 'x', 'y', 'u']
