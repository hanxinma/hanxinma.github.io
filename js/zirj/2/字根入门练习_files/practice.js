...
const root_char = ['ìn', 'àn', 'ào', 'q', 'iān', 'èn', 'àng', 'ěn', 'ué', 'h', 'n', 'ng1', 'éng', 'í', 'óng', 'āi', 'ě', 'ǐ', 'òu', 'ū', 'ǎi', 'ó', 'uǎng', 'ì', 'iào', 'íng', 'uāng', 'iáng', 'ǒng', 'ō', 'n4', 'd', 'iǔ', 'n2', 'ún', 'iōng', 'ǐn', 't', 'iǒng', 'uě', 'uā', 'ǔ', 'ǚ', 'ěi', 'üè', 'ù', 'iǎ', 'iá', 'ē', 'īn', 'uāi', 'iǎo', 'r3', 'ōng']
const root_code =  ['t', 'p', 'i', 'l', 'j', 'm', 'g', 'n', 'r', 'c', 'x', 's', 'u', 'i', 'e', 'g', 't', 'y', 'c', 'r', 'g', 's', 'v', 'a', 'q', 'k', 't', 't', 'h', 'b', 'd', 'h', 'k', 'm', 'h', 'c', 's', 't', 'm', 'o', 'b', 'd', 'p', 'e', 'f', 'l', 'p', 'z', 'w', 'f', 'f', 'm', 'h', 'f']
