var dataArray = [
"字,拼音,正确编码,错误编码,首形,尾形,解释说明",
"感,gj,kx,x,口,心,规则是先取内部尾",
"日,ri,wa,aa,囗,一,有个囗字根",
"目,mu,we,aa,囗,一,有个囗字根",
"民,mb,vv,vg,乛,乛,这个不属于戈范围内的",
"及,ji,pn,vn,丿,ㄟ,笔顺是这样的",
"量,ll,ay,r,旦,里,遇到单笔画取组合体",
"其,qi,ab,cb,一,八,特殊定义-取小需要一定的直观性",
"产,ij,lp,lp,亠,丿,取大也需要一定直观性",
"严,yj,yp,yp,一,丿,取大也需要一定直观性",
"科,ke,hu,hd,禾,十,一般是取最小字根",
"肉,rz,nr,ar,内,人,内勉强可以平移出来",
"午,wu,pg,pu,丿,干,容易错",
"养,yh,ea,ya,丷,丨,下面不是介",
"窗,il,gw,gx,宀,夂,里面不是夕",
"幽,yz,ss,as,山,幺,首笔块区域，然后往下平移出山",
"颜,yj,lr,lr,亠,人,取大也需要一定直观性",
"尤,yz,av,ad,一,乛,发龙类型的取右下",
"惑,ho,hx,ax,或,心,取一是笔画，不优先，所以取大或",
"剩,ug,qd,i,千,刂,千可以平移出，容易看不到千字",
"判,pj,dd,b,丶,刂,因为规则丿和丨不是同类，所以不能取半",
"叛,pj,dy,b,丶,又,因为规则丿和丨不是同类，所以不能取半",
"宿,su,go,gb,宀,日,容易取百，遇到多笔画，取小字",
"评,pk,yu,yp,讠,十,一般是取最小字根，字根没有平字根。所以取十",
"竹,vu,pd,pv,丿,丁,容易看不到丁",
"插,ia,fj,fa,扌,臼,臼，被穿插但是没有被分开",
"郁,yu,ye,ae,有,阝,不优先取笔画",
"乃,nd,vp,pv,乛,丿,注意笔顺",
"吼,hz,kk,kv,口,孔,不优先取笔画，优先取字和字根",
"偶,ou,rd,ry,亻,丶,禺是冷僻字，地名不算词，容易组词的才是常用字",
"戒,jp,ag,cg,丨,戈,内部尾，所以是丨，然后也不是廾，没有这个字根",
"浓,ns,dh,dn,氵,?,注意尾部是衣底字根，在h上",
"缩,so,so,sb,纟,日,遇到多笔画取小字",
"耀,yc,ea,ev,?,一,不取冷僻字，翟不能轻易组词，所以是冷僻字，人名地名组词不算",
"泰,td,fu,fu,一,氺,不是丰，没有这个字根",
"乘,ig,qn,p,千,ㄟ,千可以平移出，容易看不到千字",
"夹,jx,an,fd,一,乀,夫平移不出，所以不取",
"丧,sh,uh,th,十,?,土平移不出，所以不取",
"肃,su,vd,va,乛,丶,注意尾部笔顺是丶",
"爽,ul,an,d,大,乂,大还是平移不出，不取",
"虫,is,vd,ad,中,丶,容易看不到中",
"斜,xp,ru,rd,人,十,斗，是取小字的，没有斗这个字根",
"截,jp,ag,rg,一,戈,含戈的都先取内部尾，所以内部尾一，隹是冷僻字，不取",
"耗,hc,fm,lm,一,毛,耒是冷僻字不取",
"泛,fj,df,dz,氵,乏,不取之，遇到单笔画取组合体",
"咽,yj,kd,ky,口,大,包围类型的，都是什么外后里",
"尬,ga,aj,jj,一,介,那个不是九",
"尴,gj,am,jm,一,皿,那个不就九",
"催,cv,ra,rc,亻,一,崔，不能轻易的组词，地名人名不算，所以是冷僻字",
"宠,is,gb,gl,宀,龙,发龙类型的取右下",
"萍,pk,cu,cp,艹,十,一般是取最小字根，字根没有平字根。所以取十",
"违,ww,zw,za,辶,韦,有韦字根",
"裁,cd,hg,yg,?,戈,不取衣，h上一衣底字根。戈类型字先取内部尾",
"巫,wu,aa,g,一,一,平移不出，就不取，所以不取工",
"曰,yt,wa,aa,囗,一,有囗字根，我们外后内，包围类型",
"摊,tj,fn,fa,扌,难,隹是冷僻字不取，所以取大",
"韵,yy,ld,lj,立,冫,最小是取冫，然后遇到多笔画，所以不取习",
"愚,yu,ax,yx,丨,心,禺是冷僻字，地名不算词，容易组词的才是常用字",
"雯,wf,yx,yw,雨,乂,需头通雨",
"朕,vf,od,ot,月,大,关，最小是取大，遇到多笔画，取小",
"庸,ys,ga,gy,广,丨,里面没有用，写法不对",
"遂,sv,zd,zd,辶,丶,这个后面容易取丶，家豚类型的字根，一般在尾部都取捺，不细致区分。",
"叉,ia,yd,vd,又,丶,包围字，我们先外后内，所以平移不出也可以取又",
"嘱,vu,ku,ky,口,属,大禹是人名，人名不算词，所以禹是冷僻字",
"彦,yj,lp,lp,亠,彡,取大也需要一定直观性",
"兜,dz,be,be,丿,儿,笔顺是先丿",
"噬,ui,kw,kr,口,巫,按尾笔是一，不取笔画，所以先取巫",
"兆,vc,ed,dd,儿,丶,首笔块区域，然后往下平移出儿",
"摧,cv,fa,fc,扌,一,崔，不能轻易的组词，地名人名不算，所以是冷僻字",
"胧,ls,ob,ol,月,龙,发龙类型的取右下",
"茵,yb,cd,cy,艹,大,包围字，我们先外后内",
"翘,qn,gx,rx,一,习,像戈都取戈",
"寓,yu,gd,gy,宀,丶,禺是冷僻字，地名不算词，容易组词的才是常用字",
"咸,xm,kg,pg,口,戈,含戈的都先取内部尾，所以内部尾",
"澜,lj,dl,dn,氵,阑,阑能组词，所以不是冷僻字",
"焕,hr,hd,hn,火,大,能平移出大",
"脊,ji,do,ro,冫,月,首笔是冫",
"噩,ee,aa,wk,一,口,王平移不出，所以不取王",
"卸,xp,we,p,午,卩,午可以平移出，所以取午",
"矢,ui,pt,pd,丿,天,取码，取掉的是不看了。所以不看丿，然后取大遇到单笔画，取组合体。",
"剿,jn,id,vd,巢,刂,不优先取单笔画",
"蚊,wf,ix,iw,虫,乂,没有文字根，有乂字根",
"讳,hv,yw,ya,讠,韦,有韦字根",
"顷,qk,br,v,匕,人,大钩通小钩，所以是匕",
"尧,yc,ge,ye,戈,儿,像戈都取戈",
"禾,he,qn,p,千,ㄟ,千可以平移出，容易看不到千字",
"贬,bm,bf,bz,贝,乏,之遇到单笔化取组合体",
"烬,jb,hj,hd,火,尽,冫不是尾部的两丶，所以是取尽",
"阑,lj,mn,mj,门,ㄟ,里面是冷僻字",
"诬,wu,yw,yr,讠,巫,按尾笔是一，不取笔画，所以先取巫",
"拷,kc,fk,fv,扌,考,尾部没有字根，所以取大字",
"乓,ph,qd,qn,丘,丶,单个的小丶一般取点，不取捺，头部的丶一般也取点",
"璀,cv,wa,wc,王,一,崔，不能轻易的组词，地名人名不算，所以是冷僻字",
"笋,sy,vp,vy,⺮,丿,尹能组人名，但是人名，不算组词，不能轻易组词的都是冷僻字，不取冷僻字",
"髻,ji,ak,ik,一,口,长的繁体，繁体字算是冷僻字",
"躏,lb,za,kl,⻊,一,蔺人名，算是冷僻字。",
"瑙,nc,wx,wx,王,乂,包围字，我们先外后内",
"鬃,zs,ax,ix,一,小,长的繁体，繁体字算是冷僻字",
"臃,ys,oa,oy,月,一,人名地名都算冷僻字",
"蹩,bp,dr,dz,丶,人,足其实不在字根表上，字根表上的是⻊",
"昀,yy,od,oj,日,冫,匀，多笔画取小",
"囱,cs,pw,px,丿,夂,包围字，先外后内",
"燧,sv,hs,hn,火,遂,不优先取笔画，遂不是冷僻字，犯罪未遂",
"罹,li,sw,sa,罒,惟,隹是冷僻字不取，所以取大",
"栉,vi,lj,lj,木,卩,字根表上有和节下面一样的字根",
"勖,xu,ml,ol,冒,力,上面其实不是日",
"冒,mc,am,om,丨,目,上面其实不是日",
"濯,vo,da,dv,氵,一,不取冷僻字，翟不能轻易组词，所以是冷僻字，人名地名组词不算",
"靛,dm,qr,ar,青,人,不优先取笔画",
"鼐,nd,nd,nv,乃,鼎,尾部容易忽视鼎，不优先取笔画",
"酆,fg,ae,se,丨,阝,山平移不出，所以不取山",
"癯,qu,ba,gv,疒,一,瞿是冷僻字不取",
"趸,dy,wr,wz,万,人,z是是⻊不一样",
"锛,bf,jh,jb,钅,卉,没有廾字根",
"麸,fu,mf,af,麦,夫,捺和丶可以互通",
"谰,lj,yl,yn,讠,阑,阑尾",
"墼,ji,at,it,一,土,繁体字算冷僻字",
"疖,jp,ba,ba,疒,卩,有一样的字根",
"豳,bb,sn,an,山,ㄟ,取首笔块的区域，山可以平移出",
"鼗,tc,ey,dy,兆,又,儿平移不出，所以不取儿",
"軎,ww,ak,ik,一,口,繁体字算冷僻字",
"搿,ge,pu,uu,丿,手,变笔画不取，所以首字根不取手",
"麴,qu,um,mm,十,米,十可以平移出",
"丼,dj,jd,ad,井,丶,包围字，先外后内",
"嬅,hx,na,nh,女,丨,繁体字算冷僻字",
"豗,hv,an,wd,一,ㄟ,兀强制定义是冷僻字，因为兀和儿冲突很大，当不认识，会简单很多",
"咲,xn,kd,kt,口,大,最小字根遇到多笔画取最小",
"唓,ie,ka,ki,口,一,繁体字算冷僻字",
"奭,ui,ao,do,一,日,大移不出",
"健,jm,rj,ra,亻,建,聿，算是冷僻字，不取，所以取建",
"蠢,iy,ii,fi,春,虫,不取笔画，取大字",
"帮,bh,bj,fj,邦,巾,没有这个歪丰字根，所以取邦",
